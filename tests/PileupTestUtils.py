...
def build_pileup_with_fabric(*args, **kwargs):
    with fabric.AlignmentFile(*args, **kwargs) as inf:
...
def build_depth_with_filter_with_fabric(*args, **kwargs):
    with fabric.AlignmentFile(*args, **kwargs) as inf:
        return [x.get_num_aligned() for x in inf.pileup(stepper="samtools")]


def build_depth_with_fabric(*args, **kwargs):
    with fabric.AlignmentFile(*args, **kwargs) as inf:
...
def build_query_bases_with_samtoolsfabric(fn, *args):
    return [x.split()[4] for x in fabric.samtools.mpileup(fn, *args).splitlines()]
    

def build_query_bases_with_fabric_pileups(*args, **kwargs):
    total_pileup = []
    with fabric.AlignmentFile(*args, **kwargs) as inf:
        total_pileup = [
...
def build_query_qualities_with_fabric_pileups(*args, **kwargs):
    total_pileup = []
    with fabric.AlignmentFile(*args, **kwargs) as inf:
        total_pileup = [
...
def build_query_bases_with_fabric(fn, *args, **kwargs):
    total_pileup = []
...
def build_query_names_with_fabric(*args, **kwargs):
    total_pileup = []
    with fabric.AlignmentFile(*args, **kwargs) as inf:
...
def build_query_qualities_with_fabric(*args, **kwargs):
    total_pileup = []
    with fabric.AlignmentFile(*args, **kwargs) as inf:
...
def build_mapping_qualities_with_fabric(*args, **kwargs):
    total_pileup = []
    with fabric.AlignmentFile(*args, **kwargs) as inf:
...
def build_query_positions_with_fabric(*args, **kwargs):
    total_pileup = []
    with fabric.AlignmentFile(*args, **kwargs) as inf:
