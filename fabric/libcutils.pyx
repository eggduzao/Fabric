...
from fabric.libcsamtools cimport samtools_dispatch, samtools_set_stdout, samtools_set_stderr, \
    samtools_close_stdout, samtools_close_stderr, samtools_set_stdout_fn

from fabric.libcbcftools cimport bcftools_dispatch, bcftools_set_stdout, bcftools_set_stderr, \
...
register_error('fabric.latin1replace', latin1_replace)
...
def _fabric_dispatch(collection,
                    method,
                    args=None,
                    catch_stdout=True,
                    is_usage=False,
