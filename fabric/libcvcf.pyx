...
cimport fabric.libctabix as libctabix
cimport fabric.libctabixproxies as libctabixproxies

from fabric.libcutils cimport force_str
...
class VCF(object):
    ...
    def setreference(self, ref):
        """ Provide a reference sequence; a Python class supporting a fetch(chromosome, start, end) method, e.g. Fabric.FastaFile """
        self._reference = ref
...
###########################################################################################################
    ...
    def connect(self, filename, encoding="ascii"):
        ...
        self.tabixfile = fabric.Tabixfile(filename, encoding=encoding)
