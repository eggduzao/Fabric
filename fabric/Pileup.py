...
def iterate(infile):
    ...
    *infile* can be any iterator over a lines.
    ...
    The function yields named tuples of the type :class:`fabric.Pileup.PileupSubstitution`
    or :class:`fabric.Pileup.PileupIndel`.
    ...
    for line in infile:
        ...
        if d[2] == "*":
            try:
                ...
                raise fabric.SamtoolsError("parsing error in line: `%s`" % line)
        else:
            try:
...
def iterate_from_vcf(infile, sample):
    ...
    *infile* can be any iterator over a lines.
    ...
    :class:`fabric.Pileup.PileupSubstitution` or
    :class:`fabric.Pileup.PileupIndel`.
