...
rst_epilog = '''
.. _fabric: https://github.com/fabric-developers/fabric
...
version = fabric.version.__version__
...
extlinks = {
    'issue': ('https://github.com/fabric-developers/fabric/issues/%s', '#%s'),
    'pull':  ('https://github.com/fabric-developers/fabric/pull/%s', 'PR #%s'),
    }
