fabric: htslib interface for python
==================================
...
Fabric is a python module for reading, manipulating and writing
genomic data sets.

Fabric is a wrapper of the htslib_ C-API and provides facilities to
...
The current version wraps *htslib-1.23*, *samtools-1.23*, and *bcftools-1.23*.
...
This module is unrelated to NREL-Fabric_, which wraps the National Renewable
Energy Laboratory's System Advisor Model.

.. _NREL-Fabric: https://nrel-fabric.readthedocs.io/
